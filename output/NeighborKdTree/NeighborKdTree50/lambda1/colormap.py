...
def shiftedColorMap(cmap, start=0, midpoint=0.03, stop=1.0, name='shiftedcmap'):
    '''
...
for i in range(2, 72):
    ...
    shiftedJet_cmap = shiftedColorMap(orig_Jetcmap, start=0.0, midpoint=0.03, stop=1.0, name='shifted')
